...
if(isset($_POST["uid"])){
	$uniqueid = $_POST["uid"];
	$query = "SELECT * FROM storage_point WHERE uniqueid='$uniqueid'";
	...
	if($numrows!=0){
		...
		header("Location:StoragePoint.php");
	}
}
else{
	header("Location:StoragePoint.php");
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/StoragePointEdit.php" method="POST" class="form-horizontal" enctype = "multipart/form-data">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to edit storage point.</p>
                                </div>
