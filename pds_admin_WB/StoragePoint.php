...
<style>
        ...
        .table thead tr th {
            ...
            /* Optional: Font size for table header */
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Storage Point</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                    <h3 class="panel-title">Storage Point</h3>
                                </div>
								<a href="BulkStoragePointStatusChange.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">District-Wise Status Change</button></a>
								<a href="BulkStoragePointDataEdit.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-warning">Bulk Data Edit</button></a>
								<a href="BulkStoragePointData.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Bulk Data Add</button></a>
								...
								<a href="StoragePointAdd.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-success">Add New</button></a>
                                <a href="api/BulkStoragePointDownloadEdit.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Download Data</button></a>
                                    ...
                                    <table id="export_table" class="table datatable">
                                        <thead>
                                            <tr>
												...
												<th style="font-size:15px">Name of Storage Point</th>
												<th style="font-size:15px">Storage Point ID</th> 
												<th style="font-size:15px">Motorable/Non-Motorable</th>
												<th style="font-size:15px">Storage Point Type</th>
										...
										$query = "SELECT * FROM storage_point WHERE 1 ORDER BY district";
    ...
    <!-- START SCRIPTS -->
		...
		function edit_entry(temp_id){
			post({uid: temp_id} ,"StoragePointEdit.php");
		}
		
		function change_status(temp_id){
			post({uid: temp_id} ,"api/StoragePointStatus.php");
		}
		...
		function VerifyAndDelete(){
			...
			post({uid: temp_id,username:username,password:encrypted} ,"api/StoragePointDelete.php");
		}
