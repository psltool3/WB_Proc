...
<style>
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                    <h3 class="panel-title">Mill Inter</h3>
                                </div>
								<a href="BulkMillReplicaStatusChange.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">District-Wise Status Change</button></a>
								<a href="BulkMillReplicaDataEdit.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-warning">Bulk Data Edit</button></a>
								<a href="BulkMillReplicaData.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Bulk Data Add</button></a>
								...
								<a href="MillReplicaAdd.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-success">Add New</button></a>
                                <a href="api/BulkMillReplicaDownloadEdit.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Download Data</button></a>
                                    ...
                                    <table id="export_table" class="table datatable">
                                        <thead>
                                            <tr>
												...
												<th style="font-size:15px">To District</th>
												<th style="font-size:15px">Name of Mill Inter</th>
												<th style="font-size:15px">Mill Inter ID</th> 
												<th style="font-size:15px">Mill Inter Type</th>
										...
										$query = "SELECT * FROM mill_replica WHERE 1 ORDER BY district";
    ...
    <!-- START SCRIPTS -->
		...
		function edit_entry(temp_id){
			post({uid: temp_id} ,"MillReplicaEdit.php");
		}
		
		function change_status(temp_id){
			post({uid: temp_id} ,"api/MillReplicaStatus.php");
		}
		...
		function VerifyAndDelete(){
			...
			post({uid: temp_id,username:username,password:encrypted} ,"api/MillReplicaDelete.php");
		}
