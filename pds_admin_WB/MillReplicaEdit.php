...
<script>
    ...
    <!-- START SCRIPTS -->
		...
		<?php
			...
			echo "<script>";
			echo 'var dSelect = document.getElementById("district");';
			echo 'var tdSelect = document.getElementById("to_district");';
			echo 'for(var i = 0; i < dSelect.options.length; i++) {';
			echo '  tdSelect.add(new Option(dSelect.options[i].text, dSelect.options[i].value));';
			echo '}';
			echo "setSelectedValue('to_district','$to_district');";
			echo "</script>";
		?>
