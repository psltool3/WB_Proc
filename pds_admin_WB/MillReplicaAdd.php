...
<script>
	function verifyCaptcha() {
		...
		document.getElementById("password").value = encrypted;
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Mill Inter Add</li>
                </ul>
                <!-- END BREADCRUMB -->
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/MillReplicaAdd.php" method="POST" class="form-horizontal" enctype = "multipart/form-data">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to add new Mill Inter.</p>
                                </div>
    ...
    <!-- START SCRIPTS -->
		...
		for(var i = 0; i < dSelect.options.length; i++) {
			tdSelect.add(new Option(dSelect.options[i].text, dSelect.options[i].value));
		}
		</script>
