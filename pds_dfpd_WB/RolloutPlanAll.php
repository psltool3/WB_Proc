                                    ...
                                    <table id="export_table" class="table" >
                                        <thead>
                                            <tr>												
												...
												<!-- <th style="font-size:16px">From_Division</th> -->
												...
												<!-- <th style="font-size:16px">To_Division</th> -->
			...
			$.ajax({
				...
				success: function(result){
					...
					try{
						...
						var headers = ["Scenario", "Wheat (Qtls) Moved", "Distance (Kms)", "QKM", "Ave. Distance (Kms)*", "%Reduction w.r.t Avg. Distance in Baseline"];
						...
						cell2.innerHTML = "22,79,854";
						cell3.innerHTML = "13,31,975";
						cell4.innerHTML = "12,44,12,476";
						cell5.innerHTML = "54.57";
						cell6.innerHTML = "";
