				...
				success: function(result){
					...
					try{
						...
						for (var dataField in obj) {
							...
							/*var display_commodity = obj[dataField]["commodity"];
							if (display_commodity.toLowerCase() === "mota") {
								display_commodity = "Normal Rice";
							} else if (display_commodity.toLowerCase() === "patla") {
								display_commodity = "state FRK Rice";
							} else if (display_commodity.toLowerCase() === "saran") {
								display_commodity = "Central FRK Rice";
							}*/
							
							//var subpart1 = "<tr><td>" +  obj[dataField]["scenario"] +  "</td><td>"  + obj[dataField]["from"] +  "</td><td>"  + obj[dataField]["from_state"] +  "</td><td>"  + obj[dataField]["from_id"] +  "</td><td>"  + obj[dataField]["from_name"] +  "</td><td>"  + obj[dataField]["from_district"] +  "</td><td>"  + obj[dataField]["from_lat"] +  "</td><td>"  + obj[dataField]["from_long"] +  "</td><td>"  + obj[dataField]["to"] +  "</td><td>"  + obj[dataField]["to_state"] +  "</td><td>"  + obj[dataField]["to_id"] +  "</td><td>"  + obj[dataField]["to_name"] +  "</td><td>"  + obj[dataField]["to_district"] +  "</td><td>"  + obj[dataField]["to_lat"] +  "</td><td>"  + obj[dataField]["to_long"] +  "</td><td>"  + display_commodity +  "</td><td>"  + obj[dataField]["quantity"] +  "</td><td>"  + obj[dataField]["distance"] +  "</td><td>"  + status_part + "</td></tr>";
							//$('#table_body').append(subpart1);
						}
